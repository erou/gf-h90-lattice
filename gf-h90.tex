...
collection of compatible roots of unity $\zeta_m$, and a
representation of the corresponding finite fields $\F_p(\zeta_m)$ with
explicit embeddings
\[
\begin{array}{cccc}
