...
\category{\vspace{-.2\baselineskip}F.2.1}{Theory of computation}{Analysis of algorithms and problem complexity}[Computations in finite fields]
\category{G.4}{Mathematics of computing}{Mathematical software\vspace{-.8\baselineskip}}
\terms{\vspace{-.4\baselineskip}Algorithms,Theory\vspace{-.8\baselineskip}}
\keywords{\vspace{-.4\baselineskip}Finite fields, field extensions, Conway polynomials.\vspace{-.8\baselineskip}}
