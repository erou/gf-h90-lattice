...
Figure~\ref{fig:timings-embedding}
\begin{figure}[h]
  \centering
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=.5]{embed-3.png}
  \caption{Timings of the embeddings from $\mathbb{F}_{p}$ for $p=3$.}
  \label{fig:timings-embedding}
\end{figure}
