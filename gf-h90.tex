...
$A_\ell$ and to decore it: this gives Figure~\ref{fig:timings-decoration}. We
obtain a set of decorated Kummer algebras and for
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=.5]{solve_h90-3.png}
  \caption{Timings of the decoration for $p=3$.}
