...
\begin{algorithm}
  ...
  \begin{algorithmic}[1]
    \REQUIRE {$\F_{p^\ell}, \F_{p^m}$, for $\ell\,|\,m$ integers prime to $p$,
      and $\zeta_\ell,\zeta_m$ roots in a compatible system $\system$.}
...
\begin{algorithm}
  ...
  \begin{algorithmic}[1]
    \REQUIRE {$\F_{p^\ell}$, for $\ell$ prime to $p$, and $\system$ a system of roots.}
...
\begin{algorithm}
  ...
  \begin{algorithmic}[1]
    \REQUIRE {$\system$ a system of roots, and $(\F_{p^\ell},s_\ell)$, $(\F_{p^m},s_m)$, decorated finite fields, for $\ell\,|\,m$ integers prime to $p$.}
