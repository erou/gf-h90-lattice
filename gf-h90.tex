...
Let $\alpha_\ell\in A_\ell$, $\alpha_m\in A_m$ be nonzero solutions of \eqref{h90}
for $\zeta_\ell$ and $\zeta_m$, with Kummer constants $\a_\ell$ and $\a_m$, respectively.
Then, there is a Kummer embedding $\Phi:A_\ell\hookrightarrow A_m$
